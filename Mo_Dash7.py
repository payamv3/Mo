...
if st.session_state.step == 0:
    ...
    device_choice = st.selectbox("📱To get started, could you tell me about a smartphone that you are no longer using?\n You can start typing the model of the smartphone, e.g. iPhone SE or Samsung Galaxy, etc.", [""] + devices)
