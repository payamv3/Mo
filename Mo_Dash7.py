...
# -------------------------------
    ...
    if decision == "Resell":
        ...
        st.markdown(
            f"- After receiving, they check the phone's functionality, condition, and if the smartphone has been removed from your user account. They might modify the offer after this.")
        st.markdown(
